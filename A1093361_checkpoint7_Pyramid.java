...
public class A1093361_checkpoint7_Pyramid extends JLabel implements Runnable {
     ...
     * The TODO (Past) ********************************
     * 
     * TODO(Past): Upon a pyramid is built, it needs to first wait for 5 seconds,
     * then
    ...
    public A1093361_checkpoint7_Pyramid(int locationX, int locationY, String text, int scaler,
        ...
        imgConstruction = imgConstruction.getScaledInstance(originalGridLen / scaler
                * 2, originalGridLen / scaler * 2,
                Image.SCALE_DEFAULT);
